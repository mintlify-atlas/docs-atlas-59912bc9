---
title: "JaaS API Keys and JWT Token Generation"
...
<Steps>
  ...
  <Step title="Record the Key ID">
    Note the **Key ID** displayed next to your new key in the console. You will embed this value in the `kid` header field of every JWT token you sign with that key.
  </Step>
</Steps>
...
| `sub` | Your full JaaS domain: `<app-id>.8x8.vc`. |
...
const payload = {
  iss: 'chat',
  aud: 'jitsi',
  sub: 'vpaas-magic-cookie-<your-app-id>.8x8.vc',
