---
title: "Jitsi IFrame API Event Reference"
sidebarTitle: "Events"
description: "Complete reference for all Jitsi IFrame API events. React to participants joining, mute changes, recording state, errors, and dozens of other meeting signals."
---
...
**`lobbyStatusChanged`** — Fired when the lobby is enabled or disabled.

| Field | Type | Description |
|---|---|---|
| `lobbyEnabled` | `boolean` | `true` if the lobby is now active |
...
**`e2eeStatusChanged`** — Fired when End-to-End Encryption is enabled or disabled.

| Field | Type | Description |
|---|---|---|
| `enabled` | `boolean` | `true` if E2EE is now active |
