---
title: "Jitsi Meet config.js Reference Guide"
sidebarTitle: "config.js"
description: "Complete reference for Jitsi Meet's config.js — covering connection, P2P, video quality, toolbar, prejoin, and feature flag settings for self-hosted deployments."
---
...
<Tip>
  Reorder the buttons in the main toolbar by changing the order of entries inside `toolbarButtons`. The `'desktop'` key controls the "Share your screen" button.
</Tip>
...
<Tabs>
  <Tab title="videoQuality Object">
    ...
    <ParamField path="videoQuality.mobileCodecPreferenceOrder" type="array">
      Ordered list of preferred codecs for mobile and React Native endpoints. Example: `['VP8', 'VP9', 'H264', 'AV1']`.
    </ParamField>
...
<ParamField path="disableReactions" type="boolean" default="false">
  Disables the emoji reactions feature for all participants.
</ParamField>
