---
title: "interface_config.js: Jitsi Meet UI Configuration Options"
sidebarTitle: "Interface Config"
description: "Reference for interface_config.js UI options in Jitsi Meet: background, filmstrip, language, and branding, with IFrame API override examples."
---
...
<ParamField path="SETTINGS_SECTIONS" type="array" default='["devices","language","moderator","profile","calendar","shortcuts","sounds","more"]'>
