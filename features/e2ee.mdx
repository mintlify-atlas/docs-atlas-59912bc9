---
title: "End-to-End Encryption (E2EE) for Jitsi Meet Meetings"
sidebarTitle: "E2EE"
description: "Enable End-to-End Encryption in Jitsi Meet using WebRTC Insertable Streams so media is encrypted on-device and never readable by the server."
---
