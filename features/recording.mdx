---
title: "Record Jitsi Meetings Locally, via Jibri, or Dropbox"
sidebarTitle: "Recording"
description: "Record Jitsi meetings locally in the browser or server-side via Jibri, with Dropbox upload, file storage, and live RTMP streaming support."
---
