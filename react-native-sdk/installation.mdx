---
title: "Installing the Jitsi React Native SDK"
...
<Note>
  If you encounter peer dependency conflicts, add `--legacy-peer-deps` (npm) or `--force` (npm/yarn) to resolve them. For example: `npm install @jitsi/react-native-sdk --legacy-peer-deps`.
</Note>
